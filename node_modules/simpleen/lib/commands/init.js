...
exports.InitCommand = exports.target_languages = void 0;
...
const lodash_sortby_1 = (0, tslib_1.__importDefault)(require("lodash.sortby"));
const inquirer_checkbox_plus_prompt_1 = (0, tslib_1.__importDefault)(require("inquirer-checkbox-plus-prompt"));
const config_1 = (0, tslib_1.__importDefault)(require("../helpers/config"));
inquirer.registerPrompt("checkbox-plus", inquirer_checkbox_plus_prompt_1.default);
...
exports.target_languages = (0, lodash_sortby_1.default)([
...
const source_languages = (0, lodash_sortby_1.default)([
    { name: "Chinese", value: "ZH" },
    { name: "Dutch", value: "NL" },
 ...
 */
class InitCommand extends BaseCommand_1.default {
    async run() {
        ...
        const responses = await inquirer.prompt([
            ...
            },
            {
                ...
                source: function (answersSoFar, input) {
                    ...
                    return new Promise(function (resolve) {
                        const fuzzyResult = fuzzy.filter(input, exports.target_languages, {
            ...
            {
                name: "input_path",
                messsage: "Where is your locale file saved?  (Use glob patterns like ./**/en.json or ./**/en/*.json for multiple files)",
                type: "input",
                validate: function (answer) {
                    if (answer.length == 0) {
            ...
            {
                name: "output_path",
                message: "Where do you want to save the translations? (Combine with variables $LOCALE, $locale, $FOLDER, $FILE which are provided by the input path)",
                type: "input",
                validate: function (answer) {
                    if (answer.length == 0) {
            ...
            {
                name: "auth_key",
                message: "Enter your Authentication-Key from simpleen.io/app/#/integration",
                type: "password",
                mask: "*",
                validate: function (answer) {
        ...
        config_1.default.saveConfig(responses, flags.config);
        this.log(`Configuration ${flags.config} saved`);
    }
}
exports.InitCommand = InitCommand;
InitCommand.description = "Configure your project";
InitCommand.flags = {
